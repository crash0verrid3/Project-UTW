...
public class SimpleSwingBrowser extends JFrame {
    ...
    private void getAttrib(String attrib){
        if(attrib.toLowerCase().equals("proxy")){
            ...
            engine.loadContent("<html><body>Current version: "+ProjectUTW_VERSION+"\n<br>\nLatest version: "+latestVersion+"\n<hr>Note: This version of Project UTW does not use JxBrowser and therefore may have less support for websites as compared to the version using JxBrowser.</body></html>");
    ...
    public static void main(String[] args) throws IOException, URISyntaxException{
        ...
        SEARCH_ENGINE = SEARCH_ENGINES.get("duckduckgo");
            ...
            try{
                ...
                s.nextInt();
                latestVersion = s.nextInt();
            } catch(java.lang.Throwable e){
                // Ignore
            }
            if(latestVersion > ProjectUTW_VERSION){
                update("https://raw.githubusercontent.com/crash0verrid3/Project-UTW/master/JBrowser-noJxBrowser.jar");
            }
            loadPlugins();
            String load = null;
            if(args.length > 0){
